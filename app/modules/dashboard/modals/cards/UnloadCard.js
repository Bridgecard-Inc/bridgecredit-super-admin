...
export const UnloadCardModal = () => {
	...
	const url =
		environment === "production"
			? `https://bridgecard-card-manager-service-vbdndeke7q-uc.a.run.app/v1/issuing/cards/unload_card`
			: `https://bridgecard-card-manager-service-vbdndeke7q-uc.a.run.app/v1/issuing/sandbox/cards/unload_card`;
	...
	const closeModal = () => {
		setIsUnloadCardModalVisible(false);
	};
						...
						<form className={styles.modalForm}>
							<div className="auth-input-container">
								<input
									...
									placeholder="Unload amount in cents"
